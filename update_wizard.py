...
# We need to replace the content of {tutorialStep === 1 && ...} 
# and {tutorialStep === 2 && ...}
# and {tutorialStep === 3 && ...}
# and {tutorialStep === 4 && ...}

step1_replacement = """{tutorialStep === 1 && (
                  <motion.div 
...
step2_replacement = """{tutorialStep === 2 && (
                  <motion.div 
                    initial={{ opacity: 0, x: 20 }}
                    animate={{ opacity: 1, x: 0 }}
                    exit={{ opacity: 0, x: -20 }}
...
step3_replacement = """{tutorialStep === 3 && (
                  <motion.div 
                    initial={{ opacity: 0, x: 20 }}
                    animate={{ opacity: 1, x: 0 }}
                    exit={{ opacity: 0, x: -20 }}
...
step4_replacement = """{tutorialStep === 4 && (
                  <motion.div 
                    initial={{ opacity: 0, x: 20 }}
                    animate={{ opacity: 1, x: 0 }}
                    exit={{ opacity: 0, x: -20 }}
...
content = re.sub(r'\{tutorialStep === 1 && \([\s\S]*?\)\}', step1_replacement, content, count=1)
content = re.sub(r'\{tutorialStep === 2 && \([\s\S]*?\)\}', step2_replacement, content, count=1)
content = re.sub(r'\{tutorialStep === 3 && \([\s\S]*?\)\}', step3_replacement, content, count=1)
content = re.sub(r'\{tutorialStep === 4 && \([\s\S]*?\)\}', step4_replacement, content, count=1)
